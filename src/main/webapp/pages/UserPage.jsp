  ...
  <body onload="loadRecipes()">
    <div id="content">
      ...
      <div>
        <div id="header">
          <h2>My Recipes</h2>
          <button id="openModal" type="button" onClick="openModal()">Add Recipe</button>
        </div>
        <div class="recipes-container" id="user-recipes">
        </div>
        <div id="recipe-modal">
          <span onclick="closeModal()" class="close">&times;</span>
          <form id="recipe-form" method="POST" enctype="multipart/form-data" action="/new-recipe">
            ...
            <br><br>
            <div id="buttons">
              <button class="modal-btn" id="cancel-btn" onclick="closeModal()">Close</button>
